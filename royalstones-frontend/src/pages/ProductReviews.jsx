    ...
    <form onSubmit={handleSubmit} className="space-y-4 bg-gray-50 p-6 rounded-lg">
      ...
      <div className="flex gap-3">
        <button
          type="submit"
          disabled={submitting}
          className="flex-1 bg-blue-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed cursor-pointer"
        >
        ...
        <button
          type="button"
          onClick={onClose}
          className="px-6 py-2 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors cursor-pointer"
        >
          Cancel
        </button>
      </div>
        ...
        {isUserReview && (
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={isDeleting}
              className="text-red-600 hover:text-red-700 text-sm font-medium disabled:opacity-50 cursor-pointer"
            >
      ...
      <div className="bg-gray-50 p-6 rounded-lg">
        ...
        {!userReview && !showReviewForm && (
          <button
            ...
            className="mt-6 w-full md:w-auto bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colors cursor-pointer"
          >
